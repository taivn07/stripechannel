...
<div id="buddypress">
	...
	<?php if ( version_compare( BP_VERSION, '2.7', '<' ) || has_filter( 'bp_directory_groups_search_form' ) ) : ?>
	...
	<form action="" method="post" id="groups-directory-form" class="dir-form">
		...
		<div id="subnav" class="item-list-tabs" aria-label="<?php esc_attr_e( 'Groups directory main navigation', 'buddypress' ); ?>">
			<ul>
