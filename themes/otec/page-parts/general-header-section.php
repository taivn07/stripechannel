...
<div id="header" class="header-color">
	...
	<div class="navbar" role="navigation">
		...
		?>
		<div class="pad-header kleo-main-header<?php echo $header_class; ?>">
			<div class="container">
				...
				?> -->
				<div class="icon-pupop-menu">
					<a class="icon open woo-login-popup-sc-open" href="#">
						<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-menu.png">
					</a>
					<a class="icon close-popup" href="#">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/close-popup.png">
					</a>
				</div>
				...
				<script type="text/javascript"> 
				    $(document).ready(function() {
						...
						$(".icon-pupop-menu .open").click(function(){
						    $(".icon-pupop-menu").addClass("show-icon");
						});
						
						$(".icon-pupop-menu .close-popup").click(function(){
						    $(".icon-pupop-menu").removeClass("show-icon");
						});
				    }); 
				  </script>
