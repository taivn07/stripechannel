...
if( !function_exists( 'woo_login_styler_display_sc' ) ){
    function woo_login_styler_display_sc( $atts, $content = null ){
		...
		<div class="pad-login-popup woo-login-popup-sc-modal <?php echo ( !$args['modal'] ) ? 'woo-login-popup-sc-modal-off' : 'woo-login-popup-sc-modal-on' ; ?> <?php echo ( !empty( $args['visible'] ) && $args['modal'] && !empty( $notices ) ) ? 'woo-login-popup-sc-show' : ''; ?>">
				...
				<div class="woo-login-popup-sc-left">
					...
					<div class="cart-popup">
						<div class="icon icon-cart">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/cart-popup.png">
						</div>
						<div class="link">
							<a href="http://test-url.site/ec/cart">カートを見る</a>
						</div>
					</div>
					...
					<div class="link-popup">
						<div class="list-link">
							<p><a href="#">特定商取引法に基づく表記</a></p>
							<p><a href="#">プライバシーポリシー</a></p>
							<p><a href="#">会社概要</a></p>
							<p><a href="#">お問い合わせ</a></p>
						</div>
					</div>
