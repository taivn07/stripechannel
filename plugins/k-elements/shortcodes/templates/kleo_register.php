...
if ( $show_content && get_option( 'users_can_register' ) ) {
	...
	$register_link = function_exists( 'bp_is_active' ) ? bp_get_signup_page() : wp_registration_url();
...
?>
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <form id="register_form" class="kleo-form-register" action="<?php echo esc_url( $register_link ); ?>"
                  name="signup_form" method="post">
                <div class="row">
					<?php if ( function_exists( 'bp_is_active' ) ) { ?>
                        <div class="col-sm-6 first-col">
                            <input type="text" id="reg-username" name="signup_username" class="form-control" required
                                   placeholder="<?php _e( "Username", 'k-elements' ); ?>">
                        </div>
                        <div class="col-sm-6 last-col">
                            <input type="text" id="fullname" name="field_1" class="form-control" required
                                   placeholder="<?php _e( "Your full name", 'k-elements' ); ?>">
                        </div>
                        <div class="clear"></div>
                        <div class="col-sm-12">
                            <input type="text" id="reg-email" name="signup_email" class="form-control" required
                                   placeholder="<?php _e( "Your email", 'k-elements' ); ?>">
                        </div>
                        <div class="clear"></div>
                        <div class="col-sm-6 first-col">
                            <input type="password" id="reg-password" name="signup_password" class="form-control"
                                   required placeholder="<?php _e( "Desired password", 'k-elements' ); ?>">
                        </div>
                        <div class="col-sm-6 last-col">
                            <input type="password" id="confirm_password" name="signup_password_confirm"
                                   class="form-control" required
                                   placeholder="<?php _e( "Confirm password", 'k-elements' ); ?>">
                        </div>
                ...
                <button class="btn btn-lg btn-default btn-block" name="signup_submit"
                        type="submit"><?php esc_html_e( "Register", "k-elements" ); ?></button>
