...
class WC_Settings_Emails extends WC_Settings_Page {
	...
	public function get_settings() {
		$settings = apply_filters( 'woocommerce_email_settings', array(
			...
			array( 'title' => __( 'Email notifications', 'woocommerce' ),  'desc' => __( 'から送信される電子メール通知は、以下に記載されています。メール名をクリックして設定できます。', 'woocommerce' ), 'type' => 'title', 'id' => 'email_notification_settings' ),
