...
class WC_Email extends WC_Settings_API {
	...
	public function admin_options() {
		...
		$this->admin_actions();
		?>
		<h2 class="ads"><?php echo esc_html( $this->get_title() ); ?> <?php wc_back_link( __( 'Return to emails', 'woocommerce' ), admin_url( 'admin.php?page=wc-settings&tab=email' ) ); ?></h2>
